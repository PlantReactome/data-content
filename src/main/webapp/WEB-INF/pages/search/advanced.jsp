    ...
    <div class="grid_23 padding">
        ...
        <form id="adv-search" action="/content/query" method="get">
            <div class="advSearchBox">
                ...
                <%--</ul>--%>
                <label for="querySearchBox"></label><textarea name="q" rows="10" id="querySearchBox" class="searchBox">(raf AND map) OR (name:"PTEN S170N") OR (apoptosis) OR stID:"REACT_12858.1" OR stID:"R-OSA-1114864.1"</textarea> <%-- JP-PR --%>
            </div>
            <br>
